...
Obter os débitos pendentes de um cliente específico:
Obter os imóveis de um cliente com contratos ativos:
Obter as certidões emitidas por um cliente em um intervalo de datas:
Obter o valor total dos débitos de um cliente:
Obter as certidões emitidas com código de validação e data de validade:
Objet os clientes que possuem débitos pendentes:
Obter a quantidade de certidões emitidas por mês:
*/
